...
class Autotoreport(object):
    ...
    def __init__(self):
        ...
        self.text_url = tkinter.Entry(self.rqment_url,width=15, relief='solid')
        ...
        self.worktext = tkinter.Entry(self.MenuButton, width=20,relief='solid')
        # CONF:
        ...
        self.button4 = tkinter.Button(
            self.Listbox, text="saveConfig", height=2, command=lambda: thread_it(self.start_time_block)).pack()
        # SCROLLED：
    ...
    def job1(self):
        thread_it(self.start_submit())

    def start_time_block(self):
        scheduler.add_job(self.job1, trigger=CronTrigger(
            hour=int(TestData_Get['duration']),minute="0",day_of_week='mon-fri'))
        try:
            scheduler.start()
            print("strat")
            while True:
...
if __name__ == "__main__":
    ...
    #         print(e)
    # def time_line():
    #     scheduler.add_job(job1, trigger=CronTrigger(
    #         hour=int(TestData_Get['duration']),minute="0",day_of_week='mon-fri'))
    #     try:
    #         scheduler.start()
    #         print(1)
